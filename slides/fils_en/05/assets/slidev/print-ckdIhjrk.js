import{d as _,N as u,z as h,o as n,b as l,e as t,x as s,C as c,F as f,O as g,B as v,l as x,g as b}from"../modules/vue-CfOVo5sz.js";import{l as N,k,h as m}from"../index-C4d0Pr1U.js";import{_ as y}from"./NoteDisplay.vue_vue_type_style_index_0_lang-Drh7RYUr.js";import"../modules/shiki-BCAiZ4dZ.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(D){const{slides:d,total:p}=N();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
