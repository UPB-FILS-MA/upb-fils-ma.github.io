import{d as _,u as d,a as u,c as m,b as h,r as p,o as a,e as n,f as t,t as s,g as r,F as f,h as g,n as v,i as b,j as x,k as y,l as k,m as N,_ as w}from"./index-CcvmErVa.js";import{N as P}from"./NoteDisplay-B2N4keGu.js";const V={class:"m-4"},L={class:"mb-10"},S={class:"text-4xl font-bold mt-2"},T={class:"opacity-50"},B={class:"text-lg"},D={class:"font-bold flex gap-2"},H={class:"opacity-50"},j=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-gray-400/50 mb-8"},C=_({__name:"PresenterPrint",setup(F){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
