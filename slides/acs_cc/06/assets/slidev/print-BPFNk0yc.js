import{d as _,a3 as u,z as h,o as n,b as l,e as t,x as s,B as r,F as f,ai as g,ac as v,l as x,g as b}from"../modules/vue-HnlFfQU9.js";import{a as y,u as N,x as m}from"../index-akEjPKO7.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-gvxfNBqc.js";import"../modules/shiki-Ds-lOcJc.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},z={class:"opacity-50"},C={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(D){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
