import{d as _,N as u,z as h,o as n,b as l,e as t,x as s,B as c,F as f,O as g,C as v,l as x,g as b}from"../modules/vue-CN3z6Qym.js";import{l as N,k,h as m}from"../index-CfWWQlXg.js";import{_ as y}from"./NoteDisplay.vue_vue_type_style_index_0_lang-Cp9BfYN5.js";import"../modules/shiki-BhTuFuac.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(D){const{slides:d,total:p}=N();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
