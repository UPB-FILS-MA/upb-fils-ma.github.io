...
To build a program for the Raspberry Pi Pico, run the following command (in the project root folder):

`cargo build --bin <project_name>`

where `<project_name>` is to be replaced with the name of your project.
