...
There are 3 different ways in which MMIO can be used with the Raspberry Pi Pico:
...
If the MCU provides timers, Embassy-rs will use them to suspend the software. This is much more efficient.
